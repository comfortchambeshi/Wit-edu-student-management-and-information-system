...
//Site title
echo '<title>Online Application | '.$site_name.'</title>';
$Header = new header();
	...
	<div class="form-w3l py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="register-form pt-md-4">
				<form enctype='multipart/form-data' action="inc/admission.inc.php" method="post">
					<div class="styled-input form-group">
						<input type="text" class="form-control" placeholder="Your Name" name="full_name" required="">
					</div>
					<div class="styled-input form-group">
						<input id="datepicker" class="form-control" placeholder="Birth Date" name="dob" type="text" value="" onfocus="this.value = '';"
						 onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
					</div>
					<div class="styled-input agile-styled-input-top form-group">
						<select name="gender" class="category2" required="">
...
<div class="styled-input agile-styled-input-top form-group">
						<select name="Study programme applied for" class="category2" required="">
							<option value="">Study programme applied for</option>
							<option value="">Registered Nursing</option>
							<option value="">Accounting</option>
							<option value="">ICT Diploma</option>
							
						</select>
					</div>

					<div class="styled-input agile-styled-input-top form-group">
						<select name="study_mode" class="category2" required="">
							<option value="">Study mode</option>
							<option value="">Elearning</option>
					...
					<div class="styled-input form-group">
						<input type="number" class="form-control" minlength="10" placeholder="Phone Number" name="phone_number" required="">
					</div>
					<div class="styled-input form-group">
						<input type="text" class="form-control" placeholder="NRC number" name="nrc_number" required="">
					</div>
					
					<div class="styled-input form-group">
	<h5>Payment proof of application form</h5>
	<span>Use our Zanaco account number for payments: 12345678</span>
						<input type="file" class="form-control" placeholder="Phone Number" name="payment_file" required="">
					</div>

					
<div class="styled-input form-group">
	<h5>Statement of results</h5>
						<input type="file" class="form-control" placeholder="Phone Number" name="results_file" required="">
					</div>

					<div class="styled-input agile-styled-input-top form-group">
						<select name="courses" class="category2" required="">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
					...
					<input type="submit" name="admission_btn" value="Submit">
				</form>
			</div>
		</div>
	</div>
