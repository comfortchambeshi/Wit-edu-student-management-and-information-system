<?php
    ...
    define('EI_CONFIG_FILE_DIRECTORY', '../classes/');
    define('EI_CONFIG_FILE_DIRECTORY2', '../inc/');
    // *** config file name - output file with config parameters (database, username etc.)
    define('EI_CONFIG_FILE_NAME', 'db.php');
    define('EI_CONFIG_FILE_NAME2', 'dbconnect.inc.php');
    ...
    define('EI_CONFIG_FILE_PATH2', EI_CONFIG_FILE_DIRECTORY2.EI_CONFIG_FILE_NAME2);
    ...
    define('EI_CONFIG_FILE_TEMPLATE2', 'config2.tpl');
