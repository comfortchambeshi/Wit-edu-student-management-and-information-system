...
if (teacher_Login::isLoggedIn()) {
   ...
   $userid =  teacher_Login::isLoggedIn();
      ...
      //gettig messages 
          $RunMsg = mysqli_query($conn, "SELECT * FROM messages WHERE sent_to='$user_id' AND to_type='teacher' AND read_or_unread='unread' limit 8");
                                ...
                                <ul>
                                    <li class="dropdown profile_details_drop">
                                        ...
                                        <ul class="dropdown-menu drp-mnu">
                                           ...
                                           <form method="post" action="inc/teacher_sout.inc.php"> <li> <button class="btn-block btn-danger" name="confirm" type="submit" ><i class="fa fa-sign-out"></i> Logout</button> </li></form>
                                        </ul>
                                    </li>
                                </ul>
                            </div>';
