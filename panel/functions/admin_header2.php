       ...
       <div class="mother-grid-inner">
             <!--header start here-->
                <div class="header-main">
                    <div class="logo-w3-agile" style="background-color: skyblue; font-style: bold;">
                                <h1><a href="'.$site_url.'/panel/index.php">'.$site_name.'</a></h1>
                            </div>
                    <div class="w3layouts-left" style="background-color: #9f8f3b;">
...
if (admin_login::isadminlogged()) {
     ...
     $userid =  admin_login::isadminlogged();
        ...
        //gettig messages 
          $RunMsg = mysqli_query($conn, "SELECT * FROM messages WHERE sent_to='$user_id' AND to_type='admin'  limit 8");
          $MsgCounter = mysqli_num_rows($RunMsg);
        //getting unread alerts
         $GettingLoggedInAlerts = mysqli_query($conn, "SELECT * FROM user_alerts where alert_to=$user_id AND   alert_totype='admin' AND read_or_unread='unread'");
          $countingUnreadAlerts =  mysqli_num_rows($GettingLoggedInAlerts);

                         echo '
                         <div class="w3layouts-right" style="background-color: skyblue;">
                                ...
                                <ul>
                                    <li class="dropdown profile_details_drop">
                                        ...
                                        <ul class="dropdown-menu drp-mnu">
                                           ...
                                           <form method="post" action="inc/admin_sout.inc.php"> <li> <button class="btn-block btn-danger" name="confirm" type="submit" ><i class="fa fa-sign-out"></i> Logout</button> </li></form>
                                        </ul>
                                    </li>
                                </ul>
                            </div>';
