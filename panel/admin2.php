    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="accountants.html" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Accountants
          ...
          <li class="nav-item">
            <a href="librarians.html" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Librarians
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">How to access the student system portal
                        <span class="badge badge-warning float-right">Admin</span></a>
