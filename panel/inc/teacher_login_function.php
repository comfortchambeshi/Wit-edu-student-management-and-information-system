...
class teacher_Login extends db {
        ...
        public  function isLoggedIn() {
               ...
               if (isset($_COOKIE['SNID'])) {
                        ...
                        $sql = "SELECT teacher_id FROM teacher_login_tokens WHERE token=?";
                        $stmt = $this->connect()->prepare($sql);
                         ...
                         $row = $stmt->fetch();
                               ...
                               $SqlChecktok = "SELECT teacher_id FROM teacher_login_tokens WHERE token=?";
