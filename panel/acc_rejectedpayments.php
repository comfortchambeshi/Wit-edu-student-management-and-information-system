...
$userType = 'acc';
}elseif(admin_login::isadminlogged()){
 ...
 <div  class="wthree-crd">
                                ...
                                <div class="card-body">
                                    <div class="widget widget-report-table">
                                        ...
                                        <div class="widget-body p-15">
                                                    ...
                                                    ';
                                                    $GetPayments = mysqli_query($conn, "SELECT * FROM payments WHERE status='rejected' LIMIT 50");
        ...
        $accUname = mysqli_real_escape_string($conn,  $row['username']);
                                                    ...
                                                    ';
                                                        ...
                                                        echo "<h4 class='text-danger'>There are currently no Rejected payments</h4>";
                                                    }
