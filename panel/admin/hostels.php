  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Hostels</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
echo ' <title>Manage Hostels | '.$site_name.'</title>';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Adding a Hostel...</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
    <input type="text" class="form-control" required="" name="hostel_name" placeholder="Hostel Name" />
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="hostel_btn" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div></div>
...
$InsertClassroom = $Data->HostelInsetor($HostelName, $user_id);

	echo '<script>alert("Hostel submitted successfully!");
