...
echo ' <title>Manage classes | '.$site_name.'</title>';
...
<div class="login-clean">
    <form method="post" action="#" style="max-width: 100%;width: 100%;">
        ...
        <div class="form-group text-center"><!-- Button trigger modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Adding a classroom...</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
    <input type="text" class="form-control" required="" name="class_name" placeholder="Class Name" />
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="class_btn" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div></div>
...
$InsertClassroom = $Data->CreateClassRoom($ClassName, $user_id);

	echo '<script>alert("Class submitted successfully!");
