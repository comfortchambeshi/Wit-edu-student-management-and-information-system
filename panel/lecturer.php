...
<html>
<head>
<title>Lecturers portal | Home</title>
             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="index.php">Mamoce</a></h1>
							</div>
...
$date = date('y');
echo ' <p>© 20'.$date.' Malcolm Moffat College Of Education. All Rights Reserved | Developed by  <a href="https://fourskilllevels.com">Fourskilllevels</a></p>';
    ?>
</div>	
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="assignments.php"><i class="fa fa-bar-chart"></i><span>Assignments</span><div class="clearfix"></div></a></li>
									<li id="menu-academico" ><a href="assignments.php"><i class="fa fa-bar-chart"></i><span>Classes</span><div class="clearfix"></div></a></li>
									...
									<li id="menu-academico" ><a href="errorpage.html"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Attendance</span><div class="clearfix"></div></a></li>
									  <li id="menu-academico" ><a href="#"><i class="fa fa-cogs" aria-hidden="true"></i><span> Payment history</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="button.html">Buttons</a></li>
											<li id="menu-academico-avaliacoes" ><a href="grid.html">Grids</a></li>
										  </ul>
										</li>
									 <li><a href="tabels.html"><i class="fa fa-table"></i>  <span>Parents</span><div class="clearfix"></div></a></li>
									<li><a href="maps.html"><i class="fa fa-map-marker" aria-hidden="true"></i>  <span>Notice board</span><div class="clearfix"></div></a></li>
							        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Results</span> </span><div class="clearfix"></div></a>
