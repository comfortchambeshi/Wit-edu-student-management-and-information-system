...
echo '<title> My Private Messages | '.$site_name.'</title>';
              ...
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                 ...
                 <?php
                   ...
                   //gettig messages 
          $RunMsg = mysqli_query($conn, "SELECT * FROM messages WHERE sent_to='$user_id' AND to_type='lib'   limit 10");
              ...
              <ul class="nav nav-pills flex-column">
                <li class="nav-item active">
                  <a href="#" class="nav-link">
                    ...
                    <span class="badge bg-primary float-right">'.$MsgCounter.'</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">
         	...
         	while ($RowMsg = mysqli_fetch_assoc($RunMsg)) {
         		...
         		echo '
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read_msg.php?id='.$messageId.'">Alexander Pierce</a></td>
                    <td class="mailbox-subject"><b>'.$messageTitle.'</b> - '.$messageBody.'...
                    </td>
