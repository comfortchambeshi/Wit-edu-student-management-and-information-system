...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Final Exam Grades</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <br><br>
    ...
    <div class="container" style="background-color: #f1f7fc;">
            ...
            <?php
            $QuerryMarks = mysqli_query($conn, "SELECT * FROM exam_results WHERE marks_to='$user_id' ");
...
echo '
        ...
        echo'
                ...
                echo '<h4>There are currently no final exams results, please wait or contact your system provider!</h4>';
            }
