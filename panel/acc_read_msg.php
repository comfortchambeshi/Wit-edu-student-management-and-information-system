...
include 'functions/acc_header2.php';
...
?>
        ...
        if (isset($_GET['id'])) {
          $Msg_id = mysqli_real_escape_string($conn, $_GET['id']);
              ...
              //gettig messages 
          $RunMsg = mysqli_query($conn, "SELECT * FROM messages WHERE id='$Msg_id' AND sent_to='$user_id' OR msg_from='$user_id' AND from_type='acc' OR to_type='acc' limit 1");
