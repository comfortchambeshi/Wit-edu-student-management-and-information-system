...
?>
<title><?php echo$getStatus;?> Payment</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo$getStatus;?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <div class="widget widget-report-table">
                                        ...
                                        <div class="widget-body p-15">
                                                    ...
                                                    ';
                                                    $GetPayments = mysqli_query($conn, "SELECT * FROM payments WHERE status='$getStatus' LIMIT 50");
        ...
        $accUname = mysqli_real_escape_string($conn,  $row['username']);
         ...
         # code...
                                                    ...
                                                    ';
                                                        ...
                                                        echo "<h4 class='text-danger'>There are currently no ".$getStatus." payments</h4>";
                                                    }
