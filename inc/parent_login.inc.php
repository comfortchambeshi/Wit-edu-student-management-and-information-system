...
if (isset($_POST['proceed'])) {
   ...
   if (empty($uid) || empty($pass)) {
      header("Location: ../login.php?signin=empty");
         ...
         $result = mysqli_query($conn, "SELECT * FROM parents WHERE phone_number='$uid' OR nrc='$uid'  ");
               ...
               if ($row = mysqli_fetch_assoc($result)) {
                  ...
                  if ($hashedpwd == false) {
                     ...
                     exit();
                        ...
                        $user_id = mysqli_query($conn, "SELECT id from parents where phone_number='$uid' OR nrc='$uid'");
                        //getting user id
